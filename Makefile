...
buildp:
	$(shell ./util/design/gen-otp-img.py --img-cfg hw/ip/otp_ctrl/data/otp_ctrl_img_test_unlocked0.hjson  -o scripts/vmem_scripts/otp/otp.vmem)
	$(shell python3 ./scripts/vmem_scripts/otp/genp.py scripts/vmem_scripts/otp/otp.vmem scripts/vmem_scripts/otp/otp_rom.sv)
	$(shell mv ./scripts/vmem_scripts/otp/otp_rom.sv ./hw/ip/otp_ctrl/rtl)
