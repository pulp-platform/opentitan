...
module xbar_main (
  ...
  output tlul_pkg::tl_h2d_t tl_boot_manager_o,
  input  tlul_pkg::tl_d2h_t tl_boot_manager_i,
  ...
  assign tl_tlul2axi_o = tl_sm1_53_ds_h2d;
  assign tl_sm1_53_ds_d2h = tl_tlul2axi_i;
  ...
  assign tl_boot_manager_o = tl_sm1_60_ds_h2d;
  assign tl_sm1_60_ds_d2h = tl_boot_manager_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_34_us_h2d.a_address &
      ...
      dev_sel_s1n_34 = 5'd24;
                  ...
                  ~(ADDR_MASK_BOOT_MANAGER)) == ADDR_SPACE_BOOT_MANAGER) begin
