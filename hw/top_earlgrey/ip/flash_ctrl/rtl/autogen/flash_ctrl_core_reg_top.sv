...
module flash_ctrl_core_reg_top (
  ...
  logic [7:0] mp_region_0_base_0_qs;
  logic [7:0] mp_region_0_base_0_wd;
  logic [8:0] mp_region_0_size_0_qs;
  logic [8:0] mp_region_0_size_0_wd;
  logic mp_region_1_we;
  logic [7:0] mp_region_1_base_1_qs;
  logic [7:0] mp_region_1_base_1_wd;
  logic [8:0] mp_region_1_size_1_qs;
  logic [8:0] mp_region_1_size_1_wd;
  logic mp_region_2_we;
  logic [7:0] mp_region_2_base_2_qs;
  logic [7:0] mp_region_2_base_2_wd;
  logic [8:0] mp_region_2_size_2_qs;
  logic [8:0] mp_region_2_size_2_wd;
  logic mp_region_3_we;
  logic [7:0] mp_region_3_base_3_qs;
  logic [7:0] mp_region_3_base_3_wd;
  logic [8:0] mp_region_3_size_3_qs;
  logic [8:0] mp_region_3_size_3_wd;
  logic mp_region_4_we;
  logic [7:0] mp_region_4_base_4_qs;
  logic [7:0] mp_region_4_base_4_wd;
  logic [8:0] mp_region_4_size_4_qs;
  logic [8:0] mp_region_4_size_4_wd;
  logic mp_region_5_we;
  logic [7:0] mp_region_5_base_5_qs;
  logic [7:0] mp_region_5_base_5_wd;
  logic [8:0] mp_region_5_size_5_qs;
  logic [8:0] mp_region_5_size_5_wd;
  logic mp_region_6_we;
  logic [7:0] mp_region_6_base_6_qs;
  logic [7:0] mp_region_6_base_6_wd;
  logic [8:0] mp_region_6_size_6_qs;
  logic [8:0] mp_region_6_size_6_wd;
  logic mp_region_7_we;
  logic [7:0] mp_region_7_base_7_qs;
  logic [7:0] mp_region_7_base_7_wd;
  logic [8:0] mp_region_7_size_7_qs;
  logic [8:0] mp_region_7_size_7_wd;
  ...
  assign mp_region_0_base_0_wd = reg_wdata[7:0];

  assign mp_region_0_size_0_wd = reg_wdata[16:8];
  assign mp_region_1_we = addr_hit[29] & reg_we & !reg_error;

  assign mp_region_1_base_1_wd = reg_wdata[7:0];

  assign mp_region_1_size_1_wd = reg_wdata[16:8];
  assign mp_region_2_we = addr_hit[30] & reg_we & !reg_error;

  assign mp_region_2_base_2_wd = reg_wdata[7:0];

  assign mp_region_2_size_2_wd = reg_wdata[16:8];
  assign mp_region_3_we = addr_hit[31] & reg_we & !reg_error;

  assign mp_region_3_base_3_wd = reg_wdata[7:0];

  assign mp_region_3_size_3_wd = reg_wdata[16:8];
  assign mp_region_4_we = addr_hit[32] & reg_we & !reg_error;

  assign mp_region_4_base_4_wd = reg_wdata[7:0];

  assign mp_region_4_size_4_wd = reg_wdata[16:8];
  assign mp_region_5_we = addr_hit[33] & reg_we & !reg_error;

  assign mp_region_5_base_5_wd = reg_wdata[7:0];

  assign mp_region_5_size_5_wd = reg_wdata[16:8];
  assign mp_region_6_we = addr_hit[34] & reg_we & !reg_error;

  assign mp_region_6_base_6_wd = reg_wdata[7:0];

  assign mp_region_6_size_6_wd = reg_wdata[16:8];
  assign mp_region_7_we = addr_hit[35] & reg_we & !reg_error;

  assign mp_region_7_base_7_wd = reg_wdata[7:0];

  assign mp_region_7_size_7_wd = reg_wdata[16:8];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[28]: begin
        reg_rdata_next[7:0] = mp_region_0_base_0_qs;
        reg_rdata_next[16:8] = mp_region_0_size_0_qs;
      end

      addr_hit[29]: begin
        reg_rdata_next[7:0] = mp_region_1_base_1_qs;
        reg_rdata_next[16:8] = mp_region_1_size_1_qs;
      end

      addr_hit[30]: begin
        reg_rdata_next[7:0] = mp_region_2_base_2_qs;
        reg_rdata_next[16:8] = mp_region_2_size_2_qs;
      end

      addr_hit[31]: begin
        reg_rdata_next[7:0] = mp_region_3_base_3_qs;
        reg_rdata_next[16:8] = mp_region_3_size_3_qs;
      end

      addr_hit[32]: begin
        reg_rdata_next[7:0] = mp_region_4_base_4_qs;
        reg_rdata_next[16:8] = mp_region_4_size_4_qs;
      end

      addr_hit[33]: begin
        reg_rdata_next[7:0] = mp_region_5_base_5_qs;
        reg_rdata_next[16:8] = mp_region_5_size_5_qs;
      end

      addr_hit[34]: begin
        reg_rdata_next[7:0] = mp_region_6_base_6_qs;
        reg_rdata_next[16:8] = mp_region_6_size_6_qs;
      end

      addr_hit[35]: begin
        reg_rdata_next[7:0] = mp_region_7_base_7_qs;
        reg_rdata_next[16:8] = mp_region_7_size_7_qs;
      end
      ...
      addr_hit[97]: begin
        reg_rdata_next[18:0] = err_addr_qs;
      end
